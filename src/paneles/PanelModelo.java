    ...
    private void analizador(){
        ...
        try {
            ...
            case 2:
                ...
                break;
            case 3:
                actualizacion.actualizacionDato(panelErrores, listadoNuevosDatos, listadoFiltro, list, path, panelTexto);
                break;
            case 4:
                eliminacion.eliminacionFilas(list, listadoFiltro, panelErrores, panelTexto, path);
                break;
            default:
                break;
        }
